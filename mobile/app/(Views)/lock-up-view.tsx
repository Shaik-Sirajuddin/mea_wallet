     ...
     <View className="w-full pb-20">
      ...
      <Pressable className="border-2 flex-row justify-between mb-2 border-pink-1200 active:border-pink-1200 hover:border-pink-1200 bg-black-1200 rounded-2xl py-[13px] px-3">
        <View className="flex flex-row items-center gap-[11px]">
          ...
          <View className='bg-red-500 mb-auto -ml-2 p-1 w-5 h-5 !rounded-full items-center justify-center'>
          <Text className='text-white text-xs leading-none'>N</Text>
          </View>
        </View>
        <View className='flex-row items-start gap-4'>
          <View className='text-[15px] font-medium leading-none text-gray-1200 rounded border inline-block px-[5px] border-gray-1400'>
          <Text className='text-gray-1200 font-medium'>Unavailable</Text>
          </View>
