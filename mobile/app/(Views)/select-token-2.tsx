  ...
  return (
    ...
    <View className="w-full">
      <View className="items-center  flex-row text-center justify-between relative">
        ...
        <Text className="text-lg mx-auto font-semibold text-white">Select Token</Text>
        <Pressable 
          onPress={() => {}} 
          className="text-[17px] absolute group right-2 font-medium leading-[22px] text-gray-1200"
        >
          <Text className='text-gray-1200 font-medium group-active:text-pink-1100 '>Next</Text>
        </Pressable>
      </View>
      <View className="relative mt-6">
      <View className="flex-row items-center justify-between">
        <TextInput placeholder='To: username or address' className="text-base font-medium leading-[22px] text-gray-1200 placeholder:text-gray-1200"></TextInput>
