    ...
    <View className="flex-1 bg-black-1000">
      <View className="w-full h-full max-w-5xl mx-auto px-4 pt-8 pb-10 justify-between">
        ...
        <View className="items-center">
            ...
            <Text className="text-lg font-semibold text-white">Wallet Address</Text>
          </View>
      ...
      <View className="relative my-8">
        ...
        className="absolute top-1/2 -translate-y-1/2 right-3 bg-pink-1100 py-[5px] px-[7px] rounded-2xl">
          <Text className="text-black text-[14px] font-medium leading-[22px]">Copy</Text>
        </TouchableOpacity>
      </View>
      ...
      <View className="px-6">
        ...
        <View className='w-5 h-5 border border-white !rounded-full items-center justify-center'>
          ...
          <Text className="text-[15px] font-normal leading-5 text-gray-1000">
            Only wallet addresses created on the Solana network can be used.
          </Text>
        </View>
      </View>
    </View>
        ...
        <View className="items-center mt-6">
          <TouchableOpacity 
            ...
            <Text className="text-base group-active:text-pink-1100 font-semibold">Sharing Addresses</Text>
          </TouchableOpacity>
