      ...
      <View className="w-full h-full max-w-5xl mx-auto px-4 pt-8 pb-10 justify-between">
        ...
        <View className="items-center">
          ...
          <View className="mb-2">
            ...
            {currentPasswordError  ? (
              <Text className="text-red-500 text-xs mt-1 ml-2">{currentPasswordError }</Text>
            ) : null}
          </View>
          ...
          <View className="mb-2">
            ...
            <Text className='text-[15px] text-gray-1200 font-medium px-10'>Including lowercase letters, numbers, and special characters, 4 to 15 characters.</Text>
          </View>
        ...
        <View className="items-center mt-6">
          <TouchableOpacity 
            ...
            <Text className="text-base group-active:text-pink-1100 text-white font-semibold">OK</Text>
          </TouchableOpacity>
