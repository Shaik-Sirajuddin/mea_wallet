...
const GoogleOTP = () => {
  ...
  return (
    <View className="flex-1 bg-black-1000">
      <View className="w-full h-full max-w-5xl mx-auto px-4 pt-8 pb-10 justify-center">
        <View className="items-center">
          ...
          <View className='bg-black-1200 mb-8 flex-row rounded-md py-4 px-3 mt-2'>
            <Text className='text-base font-semibold text-white'>OTP code Setting Key</Text>
            <Text className='text-[15px] text-gray-1000 inline-block ml-2'>sdasdaderwerqw</Text>
          </View>
            ...
            <View className="pl-6 pr-10">
              <View className="flex-row items-center mb-1 gap-2.5">
                ...
                Install the Google Authenticator app from the Google Play Store.
                </Text>
              </View>
              <View className="flex-row items-center mb-1 gap-2.5">
              <View className='w-5 h-5 border border-white !rounded-full items-center justify-center'>
                ...
                <Text className="text-[15px] font-normal leading-5 text-gray-1000">
                Launch the Google Authenticator app and click the "+" button at the bottom.
                </Text>
              </View>
              <View className="flex-row items-center mb-1 gap-2.5">
              <View className='w-5 h-5 border border-white !rounded-full items-center justify-center'>
                ...
                <Text className="text-[15px] font-normal leading-5 text-gray-1000">
                Click the "Scan QR Code" button and scan the "QR Code" to register Google OTP.
                </Text>
              </View>
              <View className="flex-row items-center mb-1 gap-2.5">
              <View className='w-5 h-5 border border-white !rounded-full items-center justify-center'>
