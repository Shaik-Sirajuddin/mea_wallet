        ...
        <View className="bg-black-1000">
            <View className="w-full h-full max-w-5xl mx-auto px-4 pt-8 pb-10 flex-col justify-between">
                <View className="items-center relative">
                    ...
                    <Text className="text-lg font-semibold text-white">Your MEA Address</Text>
                </View>
                <View className="relative mt-10">
                    <View className="items-center">
                        ...
                        <View className='px-20'>
                            <Text className="text-[21px] text-center leading-2.5 font-semibold text-white mb-2">Your MEA Address</Text>
                ...
                <View>
                    <TouchableOpacity
                        ...
                        onPress={handleCopy}
                    >
                        <Text className="text-base font-semibold text-white">FBTLx.....</Text>
