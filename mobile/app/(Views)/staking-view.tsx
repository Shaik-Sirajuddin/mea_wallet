...
const StakingView = () => {
  ...
  return (
    ...
    className='px-4 pt-8'>
     ...
     <View className="w-full pb-20">
      ...
      <Pressable onPress={()=>{setVisiblePopup(true)}} className="border-2 flex-row justify-between mb-2 border-pink-1200 active:border-pink-1200 hover:border-pink-1200 bg-black-1200 rounded-2xl py-[13px] px-3">
        ...
        <Pressable onPress={()=>{setVisiblePopup(true)}} className="border-2 flex-row justify-between mb-2 active:border-pink-1200 hover:border-pink-1200 border-black-1200 bg-black-1200 rounded-2xl py-[13px] px-3">
        <View className="flex flex-row items-center gap-[11px]">
          <Image 
            source={require('../../assets/images/coin-img.png')}
            className="w-12 h-12 rounded-full"
        ...
        <Text className='text-[17px] my-5 font-semibold leading-5 text-white'>My Staking Status</Text>
  ...
  <PopupModal visible={visiblePopup} animationType='slide' setVisible={setVisiblePopup} >
    <View className='w-full px-4'>
      <View className='flex-row items-center gap-3'>
        <View className='w-16 h-16 !rounded-[100px] border-2 bg-gray-1600 border-pink-1200'>
          <Image source={require('../../assets/images/coin-img.png')} className='w-full h-full' />
        </View>
        <View>
          <Text className="text-[22px] font-medium text-white mb-2">MEA</Text>
      ...
      <View className="w-full max-w-[260px] mt-6 mb-9 mx-auto">
          ...
          <View className="flex-row justify-between mb-2">
            <Text className="text-[15px] text-white">Early Withdrawal Fee</Text>
  ...
  <PopupModalFade visible={visiblePopupStaking} setVisible={setVisiblePopupStaking} >
    <View className='w-full px-4'>
      <Text className='text-[17px] text-white text-center mb-4'>Do you want to start staking?</Text>
  ...
  <PopupModalFade visible={visiblePopupUnStaking} setVisible={setVisiblePopupUnStaking} >
    <View className='w-full px-4'>
      <Text className='text-[17px] text-white text-center mb-4'>Do you want to start Unstacking?</Text>
      <View className="flex-row items-center justify-center gap-2 px-6">
          <TouchableOpacity
