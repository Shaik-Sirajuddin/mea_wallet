...
const WithDrawal = () => {
  ...
  return (
    ...
    <View className="w-full h-full max-w-5xl mx-auto px-4 pb-10 pt-8">
    <View className="w-full h-full">
      ...
      <View className="flex flex-row items-center gap-2 mb-3">
        ...
        <Text className="text-base font-medium leading-[22px] text-white">Withdrawal possible</Text>
      </View>
      ...
      <View className="relative">
       ...
       <View className="mt-5 mb-4">
        <View className="flex flex-row items-center gap-2 mb-3">
          <View className="w-6 h-6 rounded-full bg-black-1200 border-[5px] border-gray-1100" />
          <Text className="text-base font-medium leading-[22px] text-white">Withdrawal Address</Text>
        </View>
        <TextInput
      ...
      <View className="mt-5 mb-4">
        <View className="flex flex-row items-center gap-2 mb-3">
          <View className="w-6 h-6 rounded-full bg-black-1200 border-[5px] border-gray-1100" />
          <Text className="text-base font-medium leading-[22px] text-white">Withdrawal Quantity</Text>
        </View>
