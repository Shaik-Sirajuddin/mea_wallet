      ...
      <View className="w-full pb-20">
        <View className="items-center relative">
          <Pressable 
            ...
            className="absolute left-0 top-2 z-10 p-2"
          >
        ...
        <View className="flex flex-row items-center mb-2 justify-between bg-black-1200 rounded-[15px] p-4">
          ...
          <SvgIcon name='coinImg2' width='47' height='47' />
            <View>
              <Text className="text-[17px] font-medium leading-[22px] text-white">MEA</Text>
              <View className="flex-row items-center gap-1">
                <Text className="text-[15px] font-medium leading-[22px] text-pink-1200">Copied</Text>
          ...
          <View className="flex-row gap-2">
            ...
            className="w-10 h-10 rounded-full active:bg-pink-1100 items-center justify-center bg-black-1000">
              <SvgIcon name="QRIcon" />
            </Pressable>
        ...
        <View className="flex flex-row items-center mb-2 justify-between bg-black-1200 rounded-[15px] p-4">
          ...
          <SvgIcon name='coinImg2' width='47' height='47' />
            <View>
              <Text className="text-[17px] font-medium leading-[22px] text-white">RECON</Text>
              <Text className="text-[15px] font-medium leading-[22px] text-gray-1200">GCbax...</Text>
            </View>
          </View>
          <View className="flex-row gap-2">
            <Pressable className="w-10 h-10 active:bg-pink-1100 rounded-full items-center justify-center bg-black-1000">
