          ...
          <View className="relative mt-16 h-full pb-20">
            <View className="items-center">
              <View className="flex-row w-full px-20 items-center relative gap-1 justify-center">
                <Text className="text-[52px] font-semibold leading-[68px] text-white">
                  $
                </Text>
                <TextInput
              ...
              <Text className="text-[21px] font-semibold leading-[22px] text-gray-1200 mt-1.5">
                0.00 MEA
              </Text>
            </View>
            ...
            <Pressable className="text-[17px] active:bg-gray-1200/20 mb-4 flex-row items-center justify-between font-medium rounded-[15px] py-4 px-[18px] leading-[22px] text-gray-1200">
              <Text className="text-gray-1200">
                Enter a valid amount for the quotation
              </Text>
            ...
            <PrimaryButton
              text="Send"
              className="text-base mt-auto font-semibold mb-[9px] w-full text-white leading-[22px] rounded-[15px] flex-row items-center justify-center h-[45px] bg-pink-1100 border border-pink-1100"
            ></PrimaryButton>
          </View>
        </View>
      </View>
