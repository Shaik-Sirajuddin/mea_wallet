      ...
      <View className="w-full h-full max-w-5xl mx-auto px-4 pt-8 pb-10">
        <View className="w-full">
          <View className="items-center relative">
            ...
            <TouchableOpacity className="absolute right-0 items-end justify-end z-10 p-2">
          ...
          <View className="relative mt-10">
            <View>
              ...
              <View className="bg-black-1200 mb-[1px] p-4 rounded-b-2xl flex-row items-center justify-between">
                <Text className="text-[17px] font-medium leading-[22px] text-gray-1200">
                  Sort order
                </Text>
                <CheckBox
...
export default FilterStakingEventView;
