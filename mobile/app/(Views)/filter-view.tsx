...
const FilterView = () => {
    ...
    const [checkedComp, setCheckedComp] = React.useState(false);
     ...
     const toggleCheckboxComp = () => setCheckedComp(!checkedComp);
  ...
  return (
    ...
    <View className="w-full h-full max-w-5xl mx-auto px-4 pt-8 pb-10">
     <View className="w-full">
      ...
      <View className="bg-black-1200 mb-[1px] p-4 flex-row items-center justify-between">
        <Text className="text-[17px] font-medium leading-[22px] text-gray-1200">
          Waiting
        </Text>
        <CheckBox
      ...
      <View className="bg-black-1200 mb-1 rounded-b-2xl p-4 flex-row items-center justify-between">
        <Text className="text-[17px] font-medium leading-[22px] text-gray-1200">
          Completion
        </Text>
        <CheckBox
           checked={checkedComp}
           onPress={toggleCheckboxComp}
           iconType="material-community"
           checkedIcon="checkbox-marked"
           uncheckedIcon="checkbox-blank"
           checkedColor="#ED93FF"
