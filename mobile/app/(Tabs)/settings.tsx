    ...
    <View className="bg-black-1000">
      ...
      <View className="text-center relative">
          ...
          className="flex-row items-center gap-3 px-3 py-5 mb-2 rounded-2xl border-2 border-transparent active:border-pink-1200 bg-black-1200 transition-all duration-500">
            ...
            <Text className="text-base font-semibold leading-5 text-white">Password</Text>
          </Pressable>
          ...
          className="flex-row items-center gap-3 px-3 py-5 mb-2 rounded-2xl border-2 border-transparent active:border-pink-1200 bg-black-1200 transition-all duration-500">
            ...
            <Text className="text-base font-semibold leading-5 text-white">Wallet Address</Text>
          </Pressable>
          ...
          className="flex-row items-center gap-3 px-3 py-5 mb-2 rounded-2xl border-2 border-transparent active:border-pink-1200 bg-black-1200 transition-all duration-500">
            ...
            <Text className="text-base font-semibold leading-5 text-white">Google OTP</Text>
          </Pressable>
          ...
          className="flex-row items-center gap-3 px-3 py-5 mb-2 rounded-2xl border-2 border-transparent active:border-pink-1200 bg-black-1200 transition-all duration-500">
            ...
            <Text className="text-base font-semibold leading-5 text-white">Language</Text>
          </Pressable>
          ...
          className="flex-row items-center gap-3 px-3 py-5 mb-2 rounded-2xl border-2 border-transparent active:border-pink-1200 bg-black-1200 transition-all duration-500">
            ...
            <Text className="text-base font-semibold leading-5 text-white">Customer Support</Text>
          </Pressable>
          ...
          <Pressable className="flex-row items-center gap-3 px-3 py-5 mb-2 rounded-2xl border-2 border-transparent active:border-pink-1200 bg-black-1200 transition-all duration-500">
            ...
            <Text className="text-base font-semibold leading-5 text-white">Logout</Text>
          </Pressable>
